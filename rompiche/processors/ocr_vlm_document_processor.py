...
class OCRVLMDocumentProcessor(BaseDocumentProcessor):
    ...
    def __init__(self, ocr_engine: str = "tesseract", config: Optional[Dict[str, Any]] = None):
        """
...
def process_ocr_vlm(image_path: str, prompt: str, schema: Dict[str, Any], ocr_engine: str = "tesseract") -> Dict[str, Any]:
    """
